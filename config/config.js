...
var validateEnvironmentVariable = function () {
  ...
  if(process.env.HOSTNAME && process.env.HOSTNAME.endsWith('staging')){
    process.env.NODE_ENV = 'staging';
  }
  var environmentFiles = glob.sync('./config/env/' + process.env.NODE_ENV + '.js');
  console.log("Found following value for process.env.NODE_ENV: " + process.env.NODE_ENV);
...
var initGlobalConfigFiles = function (config) {
  ...
  var models= './src/models/*.model.js';

  // Setting Globbed model files
  config.files.server.models = getGlobbedPaths(models);
...
var initGlobalConfig = function () {
  ...
  var defaultConfig = require(path.join(process.cwd(), 'config/env/development'));
